...
StreetDrive é um jogo 2D estilo *runner* desenvolvido em Python com Pygame. 
...
- Clone o repositório:
```bash
git clone https://github.com/ThalesOliveira100/StreetDrive
````
...
- Powers Ups adicionais;
- Mais estilos de carros;
- Novos obstáculos;
